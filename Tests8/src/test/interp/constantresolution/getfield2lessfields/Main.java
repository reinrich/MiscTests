...
public class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            String testClassName = "test.interp.constantresolution.getfield2lessfields.TestClassWithTestMethod";

            ClassLoader loader = new MyURLClassLoader(urls);
            ...
            while (true) {
                loader = new MyURLClassLoader(urls);
